function [X_alltime_best, F_alltime_best] = dynamic_Identif(fx_cost, fx_constraint, fx_barrier, upper_bound, lower_bound, PopSize, mass)
    %% Static.m
    ...
    sigma0_otim = X_alltime_best(1,1),sigma1_otim = X_alltime_best(1,2)
end